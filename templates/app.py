...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL', 'sqlite:///psychosocial.db')
...
# Ensure DB tables exist before first request (safe on platforms like Render)
...
# Global handler to log full tracebacks for 500 errors
